...
queue_system::frame::main::main() : wxFrame(nullptr, wxID_ANY, "System kolejkowy", wxDefaultPosition,
    ...
    auto* input1_text = new wxStaticText(app_panel, wxID_ANY, wxString::FromUTF8("Intensywność strumienia zgłoszeń"),
    ...
    auto* input2_text = new wxStaticText(app_panel, wxID_ANY, wxString::FromUTF8("Średnia intensywność obsługi"),
                                         wxDefaultPosition, wxDefaultSize, 0);
    input2_text->Wrap(-1);
    ...
    auto* input3_text = new wxStaticText(app_panel, wxID_ANY, wxString::FromUTF8("Liczba kanałów obsługi"),
                                         wxDefaultPosition, wxDefaultSize, 0);
    input3_text->Wrap(-1);
