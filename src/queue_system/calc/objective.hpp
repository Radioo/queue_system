...
namespace queue_system::calc {
    class objective : public QuantLib::CostFunction {
    public:
        explicit objective(std::uint64_t max_requests, double cost_1, double cost_2, double relative_service_intensity);
